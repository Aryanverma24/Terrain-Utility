...
router.post('/upload-user-docs', authenticate, upload.any(), uploadUserDocuments);
...
router.get('/approved-users', authenticate, getApprovedUsersByLawyer);
//route for the funtion to show documents approved for laawyer
router.get('/user-documents/:userId', authenticate, getUserDocumentsByUserId);
