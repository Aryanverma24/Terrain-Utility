  ...
  return (
    <>
      <div className="bg-mintGreen text-white min-h-screen mt-[3rem]">
        <h1 className="text-4xl font-bold text-center pt-[2rem] text-amber-800">
          Favorite <span className="">Lands</span>
        </h1>
            ...
            {Wishlist.length == 0 && (
              <>
                <div className="flex  flex-1 justify-around mr-[4rem]">
                  <img
                    className="w-[500px] mt-0 h-[320px] rounded-3xl"
                    src="https://cdn.dribbble.com/userupload/23008727/file/original-561c59bfb6274bc4d22b66b0e73b47cc.gif"
                  ></img>
                </div>
              </>
            )}
