import { FaUsers, FaCode, FaLaptopCode, FaPaintBrush, FaCogs, FaLinkedin, FaGithub, FaTwitter } from "react-icons/fa";
  ...
  const founders = [
    {
      ...
      description: "Focused on product vision, innovation, and overall platform development. Driving the strategic direction and ensuring cutting-edge solutions.",
      icon: FaLaptopCode,
    ...
    },
    {
      ...
      description: "Specializing in backend development and system architecture. Building robust and scalable infrastructure for our platform.",
      icon: FaCode,
    ...
    },
    {
      ...
      description: "Driving technical implementation and system integration. Ensuring seamless functionality and optimal performance.",
      icon: FaCogs,
    ...
    },
    {
      ...
      description: "Leading design, user experience, and frontend development. Creating intuitive and beautiful user interfaces.",
      icon: FaPaintBrush,
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed mb-4">
            Bhu-Parichiye was founded by a team of passionate innovators who aim to solve real-world 
            land management challenges through technology:
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-700 overflow-hidden border border-white/20 hover:border-emerald-200/50">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${founder.color}/5 transition-opacity duration-700 ${isHovered ? 'opacity-100' : 'opacity-0'}`}></div>

                  {/* Profile Section */}
                  <div className="relative p-6 sm:p-8">
                    {/* Avatar Placeholder */}
                    <div className="flex justify-center mb-6">
                      <div className={`w-24 h-24 sm:w-28 sm:h-28 bg-gradient-to-br ${founder.color} rounded-full flex items-center justify-center shadow-lg transform transition-transform duration-300 ${isHovered ? 'scale-110' : 'scale-100'}`}>
                ...
                {/* Glow Effect */}
                <div className={`absolute -inset-1 bg-gradient-to-r ${founder.color} rounded-2xl blur-xl opacity-0 group-hover:opacity-20 transition-opacity duration-700`}></div>
              </div>
            );
          })}
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center px-8 py-4 bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20">
            <div className="flex items-center space-x-8">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">100%</div>
                <div className="text-sm text-gray-600">Dedicated</div>
              </div>
              <div className="w-px h-8 bg-gray-300"></div>
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent">24/7</div>
