            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-b border-white/5">
                  <td className="py-3 text-white">Rahul</td>
                  <td className="text-gray-300">Land #A201</td>
                  <td className="text-emerald-400">11:30 AM</td>
                </tr>

                <tr className="border-b border-white/5">
                  <td className="py-3 text-white">Amit</td>
                  <td className="text-gray-300">Land #A355</td>
                  <td className="text-emerald-400">2:00 PM</td>
                </tr>

                <tr>
                  <td className="py-3 text-white">Simran</td>
                  <td className="text-gray-300">Land #A470</td>
                  <td className="text-emerald-400">4:15 PM</td>
                </tr>
              </tbody>
            </table>
          </div>
