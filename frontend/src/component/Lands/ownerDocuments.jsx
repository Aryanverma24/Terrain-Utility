      ...
      <div className="max-w-7xl mx-auto mb-10">
        <div className="bg-gradient-to-r from-blue-50 to-white border border-blue-200 rounded-3xl shadow-md p-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            {/* LEFT */}
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-2">👋 Welcome, Owner</h2>

              <p className="text-gray-600 text-sm leading-relaxed max-w-xl">
                Here you can track the verification status of your uploaded land
                documents. The assigned lawyer will review each document before approving
                your land.
              </p>
              ...
              <div className="mt-4 space-y-1 text-sm text-gray-700">
                <p>
                  • 🟢 <span className="font-medium">Approved</span> → Document is
                  verified successfully
                </p>
                <p>
                  • 🟡 <span className="font-medium">Pending</span> → Under review by
                  lawyer
                </p>
                <p>
                  • 🔴 <span className="font-medium">Rejected</span> → Needs correction
                  and re-upload
                </p>
                <p>
                  • If rejected, upload a corrected file using the reupload option below
                </p>
              </div>
            </div>
