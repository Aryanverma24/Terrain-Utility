  ...
  const steps = [
    {
      ...
      description: "Browse through our extensive collection of verified land properties with advanced filters.",
      details: ["Advanced search filters", "Interactive maps", "Detailed property information"]
    },
    {
      icon: FaHandshake,
      title: "Connect & Negotiate",
      description: "Get in touch with property owners and negotiate terms through our secure platform.",
      details: ["Direct messaging", "Secure communication", "Negotiation tools"]
    },
    {
      icon: FaFileContract,
      title: "Legal Verification",
      description: "Our legal experts verify all documents and ensure compliance with regulations.",
      details: ["Document verification", "Legal compliance", "Expert review"]
    },
    {
      icon: FaCheckCircle,
      title: "Complete Transaction",
      description: "Finalize your deal with secure payment processing and instant documentation.",
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 backdrop-blur-lg border border-white/20 rounded-2xl p-8 max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 mb-6">
              Join thousands of satisfied customers who found their perfect land through Bhu-Parichiye
            </p>
