        ...
        <div className="text-center">
          ...
          <div className="bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 backdrop-blur-lg border border-white/20 rounded-3xl p-12 max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Join thousands of satisfied customers who discovered their ideal property
              through Bhu-Parichiye. Start your journey today!
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 group">
              ...
              <p className="text-gray-300 mb-3">Get expert assistance from our team</p>
              <a
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 group">
              ...
              <p className="text-gray-300 mb-3">Send your queries and we'll respond</p>
              <a
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 group">
              ...
              <p className="text-gray-300 mb-3">Chat with our experts instantly</p>
              <Link
                to="/chat"
                className="text-emerald-400 font-semibold hover:text-emerald-300 transition-colors"
              >
