        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Your trusted partner for agricultural, commercial, recreational, and urban
              land opportunities. Secure, transparent, and efficient land management
              platform.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:border-emerald-400/30 transition-all duration-500">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Fertile farmland perfect for crops and sustainable agriculture
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:border-emerald-400/30 transition-all duration-500">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Prime commercial spaces for businesses and development
              </p>
              <div className="space-y-2">
                <div className="flex items-center text-emerald-400 text-sm">
                  <FaCheckCircle className="mr-2" />
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:border-emerald-400/30 transition-all duration-500">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Beautiful natural spaces for parks and resorts
              </p>
              <div className="space-y-2">
                <div className="flex items-center text-emerald-400 text-sm">
                  <FaCheckCircle className="mr-2" />
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:border-emerald-400/30 transition-all duration-500">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Strategic urban plots for modern development
              </p>
              <div className="space-y-2">
                <div className="flex items-center text-emerald-400 text-sm">
                  <FaCheckCircle className="mr-2" />
                ...
                {!subscribed ? (
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-emerald-200/80">
                      Check your email for exclusive insights
                    </p>
                  </div>
                )}
              </div>
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <li>
                <Link
                  to="/"
                  onClick={scrollOntop}
                  className="group flex items-center p-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl hover:bg-emerald-500/20 hover:border-emerald-400/50 transition-all duration-300"
                >
          ...
          <div className="lg:col-span-2 mt-12">
            <div className="bg-gradient-to-br from-emerald-500/20 to-cyan-500/30 backdrop-blur-lg border border-emerald-400/40 rounded-2xl p-8 text-center hover:border-emerald-400/60 transition-all duration-500">
              ...
              <p className="text-emerald-100 text-lg leading-relaxed mb-6">
                Get exclusive access to premium properties, market insights, and expert
                recommendations
              </p>
        ...
        <div className="flex flex-col lg:flex-row justify-around items-center mt-10 pb-10">
          ...
          <div className="text-center lg:text-left mb-6 lg:mb-0">
            <div className="flex items-center mb-2">
              ...
              <span className="text-emerald-400 font-bold text-lg mx-2">
                Bhu-Parichiye
              </span>
              <span className="text-white text-xs bg-emerald-500/20 px-2 py-1 rounded-full">
                PREMIUM
              </span>
            </div>
            <p className="text-white text-sm">
              Empowering land transactions with{' '}
              <span className="text-emerald-400">AI technology</span> and{' '}
              <span className="text-cyan-400">blockchain security</span>
            </p>
