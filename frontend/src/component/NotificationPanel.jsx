...
export default function NotificationPanel({ currentUserId, role }) {
  ...
  const loadNotifications = async () => {
    ...
    try {
      ...
      const filtered = data.filter((n) => {
        ...
        if (role === 'lawyer')
          return n.targetRole === 'lawyer' && n.userId.toString() === userId;
  ...
  useEffect(() => {
    ...
    const handleNewNotification = (notif) => {
      ...
      const shouldShow =
        (role === 'lawyer' &&
          notif.targetRole === 'lawyer' &&
          notif.userId.toString() === userId) ||
  ...
  return (
    <div className="relative z-50">
      ...
      >
        ...
        <span className="text-emerald-400 font-semibold text-sm">Notifications</span>

        {/* Unread Count Badge */}
        {unread > 0 && (
          <span
            className="absolute -top-2 -right-2 min-w-[24px] h-6 
      ...
      {isDropdownOpen && (
        <>
          ...
          {/* Dropdown Content */}
          <div
            className={`absolute right-0 mt-3 w-96 max-h-[500px] 
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div
                    className="w-10 h-10 bg-gradient-to-r from-emerald-500 to-cyan-500 
            ...
            <div className="max-h-80 overflow-y-auto custom-scrollbar">
              {notifications.length > 0 ? (
                ...
                <div className="p-8 text-center">
                  <div
                    className="w-16 h-16 bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 
