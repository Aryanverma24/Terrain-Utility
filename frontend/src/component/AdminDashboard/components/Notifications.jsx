    ...
    const fetchNotifications = async () => {
      ...
      const sampleNotifications = [
        ...
        },
        {
          ...
          message:
            "Your land 'Commercial Property in Downtown' has been approved and is now live",
        ...
        },
        {
          ...
          message:
            'Payment processing failed for land #1234. Please update payment information.',
        ...
        },
        {
          ...
          message:
            'Scheduled system maintenance on March 25, 2024 from 2:00 AM to 4:00 AM EST',
        ...
        },
        {
          ...
          title: 'Land Sold',
          message:
            "Congratulations! Your land 'Residential Plot' has been sold to buyer Sarah Wilson",
        ...
        },
        {
          ...
          message:
            'Admin privileges have been granted to Michael Johnson (mjohnson@admin.com)',
        ...
        },
        {
          ...
          message:
            'Multiple failed login attempts detected for user admin@example.com from IP address 192.168.1.100',
        ...
        },
        {
          ...
          message:
            'New features have been added to the admin dashboard including advanced analytics and reporting tools',
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center space-x-2 mt-3">
                    <button
                      onClick={() =>
                        handleNotificationAction(notification.id, notification.action)
                      }
