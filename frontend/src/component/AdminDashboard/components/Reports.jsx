...
import { FaClipboardList, FaFileAlt, FaDownload, FaExclamationTriangle, FaCheckCircle } from "react-icons/fa";
                    ...
                    },
                    {
                        ...
                        data: {
                            ...
                            averagePrice: allLands.length
                                ? (
                                    allLands.reduce((sum, l) => sum + (l.price || 0), 0) /
                                    allLands.length
                                  ).toFixed(2)
                                : 0
                        }
    ...
    return (
        <AdminDashboardLayout>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <StatCard title="Total Reports" value={reports.length} icon={<FaClipboardList />} />
                <StatCard title="Completed" value={reports.filter(r => r.status === "completed").length} icon={<FaCheckCircle />} />
                <StatCard title="In Progress" value={reports.filter(r => r.status === "in_progress").length} icon={<FaExclamationTriangle />} />
                <StatCard title="Financial" value={reports.filter(r => r.type === "Financial").length} icon={"📊"} />
            </div>
