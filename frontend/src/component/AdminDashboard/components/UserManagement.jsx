        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-6 hover:bg-white/15 transition-all duration-300">
            <div className="text-center">
              <p className="text-gray-400 text-sm font-medium mb-2 uppercase tracking-wide">
                Total Users
              </p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/20">
                  ...
                  <th className="py-3 px-4 text-left text-emerald-400 font-semibold text-center">
                    Role
                  </th>
                  <th className="py-3 px-4 text-center text-emerald-400 font-semibold">
                    Actions
                  </th>
                </tr>
              </thead>
                  ...
                  >
                    <td className="py-3 px-4">
                      <div className="flex items-center">
                        <div
                          className={`w-8 h-8 rounded-full mr-3 flex items-center justify-center ${user.isAdmin ? 'bg-gradient-to-br from-purple-500 to-pink-500' : 'bg-gradient-to-br from-emerald-500 to-cyan-500'}`}
                        >
                        ...
                        <div>
                          ...
                          {user.isAdmin && (
                            <span className="ml-2 px-2 py-1 bg-purple-500/20 text-purple-400 text-xs rounded-full border border-purple-400/30">
                              Admin
                            </span>
                          )}
                        </div>
                    ...
                    <td className="py-3 px-4 text-center">
                      {!user?.isAdmin ? (
                        ...
                        <div
                          className="ml-6 bg-purple-500/20 w-10 h-10 text-purple-400 p-2 rounded-lg flex items-center justify-center"
                          title="Admin User"
                        >
                          <FaUserShield />
                        </div>
