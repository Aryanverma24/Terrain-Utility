...
const AdminSidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      className={`fixed left-0 top-0 h-full bg-gradient-to-b from-slate-900 via-emerald-900/20 to-slate-900 border-r border-emerald-500/20 transition-all duration-300 z-50 ${sidebarOpen ? 'w-64' : 'w-20'} flex flex-col backdrop-blur-xl`}
    >
      {/* Header */}
