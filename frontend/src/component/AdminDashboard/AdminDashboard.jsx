  ...
  return (
    <AdminDashboardLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
        <StatCard title="Total Users" value="1,240" icon={<FaUsers />} growth="+12%" />

        <StatCard title="Total Lands" value="320" icon={<FaLandmark />} growth="+8%" />

        <StatCard title="Admin Users" value="12" icon={<FaUserShield />} growth="+2%" />

        <StatCard title="Reports" value="45" icon={<FaClipboardList />} growth="+5%" />
      </div>
