...
const LawyerDocuments = () => {
  ...
  const isAlreadyVerified =
    land?.geoVerification && land.geoVerification.status !== 'pending';

  //--------the self decaralartion segemnt----------
  const isDeclarationDone = land?.geoVerification?.lawyerDeclaration?.accepted === true;
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div>
              ...
              <div className="mt-4 space-y-1 text-sm text-gray-700">
                ...
                <p>
                  • Once all are reviewed, return to previous page for final land approval
                </p>
              </div>
            </div>
            ...
            <div className="bg-white border border-emerald-200 rounded-2xl px-6 py-4 shadow-sm text-center min-w-[200px]">
              ...
              <p className="text-2xl font-bold text-emerald-600">
                {fullDocs.filter((d) => d.status === 'approved').length} /{' '}
                {fullDocs.length}
              </p>
        ...
        <div className="max-w-7xl mx-auto mt-16 bg-white p-8 rounded-3xl shadow-xl border border-blue-200">
          ...
          {showGeoResult && (
            <div className="mt-8 p-6 rounded-2xl border border-blue-200 bg-blue-50">
              ...
              <p>
                ...
                <span
                  className={`font-semibold ${autoStatus === 'matched' ? 'text-green-600' : 'text-red-600'}`}
                >
                  {autoStatus}
                </span>
              </p>
          ...
          {geoResult && (
            <div className="mt-6 p-4 rounded-xl border bg-gray-50">
              <p>
                <strong>Status:</strong> {geoResult.status}
              </p>
              <p>
                <strong>Distance:</strong> {geoResult.distance?.toFixed(3)} km
              </p>
              <p>
                <strong>Note:</strong> {geoResult.note || 'No note'}
              </p>
            </div>
          )}
          ...
          {isAlreadyVerified && land?.geoVerification && (
            <div className="mt-6 p-6 rounded-2xl border bg-green-50">
              ...
              <p>
                <strong>Distance:</strong> {land.geoVerification.distance?.toFixed(3)} km
              </p>
              <p>
                <strong>Owner Coordinates:</strong> Lat: {land.location?.coordinates?.[1]}{' '}
              ...
              <p>
                <strong>Note:</strong> {land.geoVerification.note || 'No note provided'}
              </p>
        ...
        : 'border-gray-200 bg-white'
            ...
            >
              ...
              <div className="text-gray-600 text-sm space-y-3 leading-relaxed">
                <p>
                  I hereby confirm that I have carefully reviewed all submitted property
                  documents and verified their authenticity to the best of my knowledge.
                </p>

                <p>
                  I have also verified the geographical location of the property and
                  ensured that it matches the provided coordinates.
                </p>

                <p>
                  I understand that approving incorrect or fraudulent documents may lead
                  to legal consequences and professional liability.
                </p>
