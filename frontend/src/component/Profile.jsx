...
const Profile = () => {
  ...
  const handleUserReupload = async (docId, file) => {
    ...
    try {
      ...
      const res = await API.put(`/api/users/file/${docId}/reupload`, formData, {
        headers: {
  ...
  const fetchDocuments = async () => {
    try {
      ...
      const res = await axios.get('http://localhost:5000/api/users/my-documents', {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
          ...
          <div className="flex gap-5">
            <div className="bg-sandBrown mb-5 w-1/4 h-[28rem] rounded-xl">
              <div className="flex flex-col items-center">
                <div
                  className="px-1 py-1 w-[12rem] h-[12rem] flex justify-center items-center mt-[1rem] object-cover bg-richBrown
                        rounded-full"
                >
                  <img
                    ...
                    <div className="w-full max-w-2xl bg-mintGreen border border-sand500 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.25)] p-8 relative">
                      ...
                      >
                        <p className="text-sm text-darkWalnut leading-relaxed">
                          I confirm that all submitted documents are authentic and belong
                          to me. I understand that submitting false documents may result
                          in legal action.
                        </p>
            ...
            <div className="bg-sandBrown mb-5 w-1/3  rounded-xl">
              ...
              <div className="flex flex-col gap-5 pt-5 mt-[1rem] text-lg px-6 text-richBrown font-semibold">
                <div className="flex">
                  ...
                  {userdata.data.City !== 'unknown' &&
                    userdata?.data.City[0].toUpperCase() +
                      userdata?.data.City.substring(1) +
                      ' , '}
                  {userdata.data.state !== 'unknown' &&
                    userdata.data?.state[0].toUpperCase() +
                      userdata?.data.state.substring(1)}
                </div>
            ...
            <div className="bg-sandBrown mb-5 w-[38%] rounded-xl">
              ...
              <div className="flex flex-col gap-4 pt-5 text-lg px-4 text-richBrown font-semibold">
                {lands &&
                  lands.map((land) => (
                    <>
                      <Link to={`/land/${land._id}`} className="min-h-[10rem]">
                          ...
                          {land.image && (
                            <div className=" flex items-center">
                              ...
                              <div className="container ml-3 text-white text-md font-normal">
                                ...
                                <h3>
                                  City :{' '}
                                  {land.city[0].toUpperCase() + land.city.substring(1)}
                                </h3>
                                <h3>
                                  Owner :{' '}
              ...
              <Link to="/mylands" className="flex justify-center">
        ...
        <div className="bg-black absolute bg-opacity-50 w-full top-[2rem] min-h-screen">
          ...
          <div className="flex flex-col ml-[30%] px-4 pb-4 justify-center mt-[3rem] bg-mintGreen w-[30rem] rounded-xl md:scale-[85%] md:mt-[0.5rem]">
            <div className="relative">
              <h2 className="text-xl pt-[1rem] text-center mb-[1rem] font-semibold text-darkWalnut">
                Edit Profile
              </h2>
              <button
                className="text-2xl absolute top-4 right-1"
            ...
            >
              ...
              <option value="male" className="text-darkWalnut font-bold">
                Male
              </option>
              <option value="female" className="text-darkWalnut font-bold">
                Female
              </option>
            </select>

            <textarea
              className="px-2 py-1 col-auto rounded-lg mb-4 outline-cardGreen outline-2 text-black"
            ...
            <div className="flex justify-center items-center">
              <button
                className="text-xl bg-cardGreen text-darkWalnut font-semibold py-1 px-2 rounded-2xl w-3/6 "
