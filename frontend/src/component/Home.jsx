          ...
          {user?.username ? <>
             <div className="flex justify-between  mx-[2rem]">
                <div className="text-2xl text-center ml-[32rem]">
                  <h2 className="pt-[3rem] font-semibold">WELCOME <span className="font-bold uppercase text-green-600">{user?.username}</span></h2>
                </div>
                  <div className="mt-[2.5rem] py-1 px-2 rounded-2xl font-bold text-xl bg-green-400
              ...
              {lands.map(land=> (
                  ...
                  <div  key={land.id} className="w-[20rem]" >
                      <div className="bg-blue-200 p-[0.5rem] m-5 rounded-xl">
                        ...
                        <>  
                             <img src="https://thumbs.dreamstime.com/b/leased-industrial-land-sign-advertises-acreages-lease-72963893.jpg?w=768" alt="industrial" 
                             className="rounded-xl"/>
                        </> :
                          land.landtype == "residental" ?
                          <>
                               <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXegl3w1mUrzaDncOWIWe5YEGnI_HdWYIk7w&s" alt="industrial"
                               className="rounded-xl" />
                          </> : 
                          <>
                          </>
