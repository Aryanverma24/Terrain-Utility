...
const RegistrarLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await API.post('/api/registrar/login', {
        uniqueId: formData.uniqueId,
        password: formData.password,
      });

      localStorage.setItem('registrarToken', response.data.token);

      localStorage.setItem('registrar', JSON.stringify(response.data.registrar));

      localStorage.setItem('role', 'registrar');

      toast.success('Registrar login successful');
        ...
        <div className="flex flex-col lg:flex-row bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="w-full lg:w-1/2 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 p-10 lg:p-12 flex flex-col justify-center relative overflow-hidden">
            <div className="absolute inset-0 opacity-10">
              <div
                ...
                style={{
                  backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='white' fill-opacity='0.3'%3E%3Ccircle cx='30' cy='30' r='4'/%3E%3C/g%3E%3C/svg%3E")`,
                }}
              ></div>
            </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-emerald-100 text-lg mb-10">
                Access appointment scheduling, deed registration and mutation approval
                workflow.
              </p>
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center text-white">
                  ...
                  <div>
                    <h3 className="font-semibold">Transfer Authorization</h3>
                    <p className="text-emerald-200 text-sm">
                ...
                <div className="flex items-center text-white">
                  ...
                  <div>
                    <h3 className="font-semibold">Mutation Workflow</h3>
                    <p className="text-emerald-200 text-sm">Generate mutation drafts</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-full lg:w-1/2 p-8 lg:p-12">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-900">Registrar Sign In</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 rounded-xl border ${
                      errors.uniqueId ? 'border-red-400 bg-red-50' : 'border-gray-300'
                    }`}
                    disabled={isLoading}
                  />
                </div>
                ...
                {errors.uniqueId && (
                  <p className="text-red-600 text-sm mt-2">{errors.uniqueId}</p>
                )}
              </div>
