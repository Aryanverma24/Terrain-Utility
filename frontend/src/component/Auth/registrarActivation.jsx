...
const RegistrarActivate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await API.post('/api/registrar/activate', formData);

      toast.success(response.data.message || 'Registrar account activated');
          ...
          <div className="w-full lg:w-1/2 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 p-10 lg:p-12 flex flex-col justify-center relative overflow-hidden">
            <div className="absolute inset-0 opacity-10">
              <div
                ...
                style={{
                  backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='white' fill-opacity='0.3'%3E%3Ccircle cx='30' cy='30' r='4'/%3E%3C/g%3E%3C/svg%3E")`,
                }}
              ></div>
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-5">
                <div className="flex items-center text-white">
                  ...
                  <div>
                    <h3 className="font-semibold">Appointment Handling</h3>
                ...
                <div className="flex items-center text-white">
                  ...
                  <div>
                    <h3 className="font-semibold">Mutation Draft Workflow</h3>
                    <p className="text-emerald-200 text-sm">
                ...
                <div className="flex items-center text-white">
                  ...
                  <div>
                    <h3 className="font-semibold">Secure Government Access</h3>
                    <p className="text-emerald-200 text-sm">
          ...
          <div className="w-full lg:w-1/2 p-8 lg:p-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                {errors.officialEmail && (
                  <p className="text-red-600 text-sm mt-2">{errors.officialEmail}</p>
                )}
              </div>
